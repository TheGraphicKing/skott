...
const COMMANDS: CommandGroup[] = [
  {
    ...
    items: [
      ...
      { label: "Campaigns",      icon: Rocket,    href: "/campaigns",     shortcut: "⌘2" },
      { label: "Content Studio", icon: PenTool,   href: "/content-studio",shortcut: "⌘3" },
      { label: "Intelligence",   icon: Brain,     href: "/intelligence",  shortcut: "⌘4" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Generate SEO Brief",           icon: FileSearch, href: "/seo",           shortcut: null },
      { label: "Run Competitor Analysis",      icon: Shield,     href: "/intelligence",  shortcut: null },
      { label: "Create Board Report",          icon: Layers,     href: "/chief-of-staff",shortcut: null },
    ],
  },
  {
    group: "Recent",
    items: [
      { label: "Q2 Enterprise Launch Campaign", icon: Clock, href: "/campaigns",   shortcut: null },
      { label: "LinkedIn ABM Strategy",          icon: Clock, href: "/campaigns",   shortcut: null },
      { label: "EMEA Expansion Analysis",        icon: Clock, href: "/intelligence",shortcut: null },
    ],
  },
];
